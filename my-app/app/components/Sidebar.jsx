    ...
    <>
      {aberta && (
        <>
          ...
          <aside className="fixed left-0 top-0 h-screen w-72 bg-blue-500 text-yellow-200 z-50">
            
            <div className="flex justify-center p-5">
            <div className="size-30 bg-blue-500 rounded-full"></div>
            </div>
            <div className="bg-blue-500 p-4 border-b border-b-yellow-400 w-100 h-30">
            </div>
